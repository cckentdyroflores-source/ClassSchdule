...
<head>
    ...
    <title><?php echo $__env->yieldContent("title", "Class Schedule System"); ?></title>
...
<div id="sidebar">
    ...
    <div class="nav-item">
        <a href="<?php echo e(route("schedules.index")); ?>" class="<?php echo e(request()->routeIs("schedules.*") ? "active" : ""); ?>">
    ...
    <div class="sidebar-footer">
        <a href="<?php echo e(route("profile.edit")); ?>" class="user-chip">
            <div class="user-avatar">
                <?php if(auth()->check() && auth()->user()->profile_picture): ?>
                    <img src="<?php echo e(asset("storage/" . auth()->user()->profile_picture)); ?>" alt="">
                <?php else: ?>
                    <?php echo e(auth()->check() ? strtoupper(substr(auth()->user()->name, 0, 2)) : ""); ?>

                <?php endif; ?>
            </div>
            <div class="user-meta">
                
                <div class="user-name"><?php echo e(auth()->check() ? auth()->user()->name : ""); ?></div>
...
<div class="main-content">
    <div class="topbar">
        ...
        <div class="d-flex align-items-center gap-2">
            <span class="text-muted" style="font-size:12px"><?php echo e(now()->format("M d, Y")); ?></span>
...
<?php if(session("toast_success")): ?>
    showToast("success", <?php echo json_encode(session("toast_success"), 15, 512) ?>);
<?php endif; ?>
<?php if(session("toast_info")): ?>
    showToast("info", <?php echo json_encode(session("toast_info"), 15, 512) ?>);
<?php endif; ?>
<?php if(session("toast_warning")): ?>
    showToast("warning", <?php echo json_encode(session("toast_warning"), 15, 512) ?>);
<?php endif; ?>
<?php if(session("toast_danger")): ?>
    showToast("danger", <?php echo json_encode(session("toast_danger"), 15, 512) ?>);
<?php endif; ?>
</script>
...
<?php /**PATH C:\xampp\htdocs\ClassSchedule\resources\views/layouts/app.blade.php ENDPATH**/ ?>