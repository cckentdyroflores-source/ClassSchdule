...
<div class="auth-wrap">
    <div class="auth-left">
        ...
        <p class="tagline">Your complete class schedule management platform for students and educators.</p>
        <div class="decorative">
            <div class="deco-card"><div class="label">Total Users</div><div class="val"><?php echo e($totalUsers); ?></div></div>
            <div class="deco-card"><div class="label">Schedules</div><div class="val"><?php echo e($totalSchedules); ?></div></div>
            <div class="deco-card"><div class="label">Subjects</div><div class="val">12</div></div>
            <div class="deco-card"><div class="label">Rooms</div><div class="val">8</div></div>
        </div>
    </div>
    <div class="auth-right">
        <div class="auth-box">
            <h2>Welcome back</h2>
            <p class="sub">Sign in to your ClassSync account</p>
...
unset($__errorArgs, $__bag); ?>" id="email" name="email" placeholder="admin@classsync.edu" value="<?php echo e(old('email')); ?>" required autofocus>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:1.25rem;">
                    ...
                    <a href="#" style="font-size:.85rem;color:var(--accent);text-decoration:none;">Forgot password?</a>
                </div>
                <button type="submit" class="btn-primary-custom">Sign In</button>
            </form>
            <div class="auth-link">Don't have an account? <a href="<?php echo e(route('register')); ?>">Create account</a></div>
        </div>
    </div>
</div>
</body>
</html><?php /**PATH C:\xampp\htdocs\ClassSchedule\resources\views/auth/login.blade.php ENDPATH**/ ?>