...
<?php $__env->startSection('title', 'Class Schedules'); ?>
<?php $__env->startSection('page-title', 'Class Schedules'); ?>
...
<form method="GET" action="<?php echo e(route('schedules.index')); ?>" class="filter-bar">
...
<div class="schedule-card">
    <div style="overflow-x:auto;">
        <table class="schedule-table">
            ...
            <?php $__empty_1 = true; $__currentLoopData = $schedules ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $s): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                ...
                <tr>
                    ...
                    <td>
                        <span class="time-val">
                            <?php echo e($s->formatted_start ?? date('H:i', strtotime($s->start_time ?? now()))); ?><span class="time-sep">–</span><?php echo e($s->formatted_end ?? date('H:i', strtotime($s->end_time ?? now()))); ?>
                        ...
                        <div class="row-actions">
                            <button
                                ...
                                onclick="openEditSchedule(
                                    <?php echo e($s->id ?? 0); ?>,
                                    <?php echo \Illuminate\Support\Js::from($s->subject)->toHtml() ?>,
                                    <?php echo \Illuminate\Support\Js::from($s->day)->toHtml() ?>,
                                    '<?php echo e(isset($s->start_time) ? substr($s->start_time, 0, 5) : ''); ?>',
                                    '<?php echo e(isset($s->end_time) ? substr($s->end_time, 0, 5) : ''); ?>',
                                    <?php echo \Illuminate\Support\Js::from($s->room)->toHtml() ?>,
                                    <?php echo \Illuminate\Support\Js::from($s->instructor)->toHtml() ?>
                                )"
                            >
                                <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                            ...
                            <form
                                method="POST"
                                action="<?php echo e(route('schedules.destroy', $s->id ?? 0)); ?>"
...
function openAddSchedule() {
    ...
    form.action = "<?php echo e(route('schedules.store')); ?>";
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\ClassSchedule\resources\views/schedules/index.blade.php ENDPATH**/ ?>