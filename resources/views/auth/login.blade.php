...
<div class="auth-wrap">
    <div class="auth-left">
        ...
        <div class="decorative">
            <div class="deco-card"><div class="label">Total Users</div><div class="val">{{ $totalUsers }}</div></div>
            <div class="deco-card"><div class="label">Schedules</div><div class="val">{{ $totalSchedules }}</div></div>
...
<form method="POST" action="{{ route('login') }}">
    @csrf
                <div class="form-group">
                    ...
                    <input type="email" class="form-control @error('email') is-invalid @enderror" id="email" name="email" placeholder="admin@classsync.edu" value="{{ old('email') }}" required autofocus>
            ...
            <div class="auth-link">Don't have an account? <a href="{{ route('register') }}">Create account</a></div>
        </div>
    </div>
</div>
</body>
